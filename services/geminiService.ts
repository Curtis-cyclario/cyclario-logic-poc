...
/**
 * SECURE: Refactored to use a server-side proxy to protect the API key.
 * The client now calls a local /api/generate endpoint which is proxied
 * by the Vite development server, injecting the GEMINI_API_KEY securely.
 */
export const generateDesign = async (prompt: string): Promise<string> => {
  try {
    ...
    // EXTRACT: Accessing the generated text from the JSON response structure.
